...
<div class="row">
		<div class="main card-panel col s12">
			...
			<div class="v-cont col s7 offset-s1">
				...
				<br><hr>
				<form name="save" method="post" action="/content/save_lang_ach">
			...
			<h6>type your comment here :</h6>
				<form class="card-content brown lighten-4 deep-orange darken-4-text" method="post" action="/content/comment_lang">
					<input type="hidden" name="less_id" value="<?= $this->uri->segment(3)?>">
					<input type="hidden" name="user_id" value="<?= $_SESSION['user_id']; ?>">
